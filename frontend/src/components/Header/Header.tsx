    ...
    <>
      ...
      >
        ...
        >
          ...
          <Link
            to="/appinfo"
            className={` hover:bg-[#3D9D9D] hover:border-[1px] hover:border-[#008080] ${
              path === "appinfo"
                ? "bg-[#FF7F50] border-[1px] border-[#FF8356]"
                : "bg-[#0A2239]"
            ...
            {open && (
              <div className="bg-[#D9D9D9] shadow-[0px_9px_24px_-13px_#3333331A] absolute top-[47px] w-[150px] right-0 rounded-[10PX] flex sm:flex-row flex-col sm:gap-[10px] gap-[8px] p-[8px_10px]">
                ...
                {access_token && (
                  <Link
                    to="/appdetails"
                    className={`bg-[#0A2239] text-[#fff] hover:bg-[#3D9D9D] hover:border-[1px] hover:border-[#008080]  ${
                      path === "appdetails"
                        ? "bg-[#FF7F50] border-[1px] border-[#FF8356]"
                        : "bg-[#0A2239]"
                ...
                {access_token && (
                  <Link
                    to="/appinfo"
                    className={`bg-[#0A2239] hover:bg-[#3D9D9D] hover:border-[1px] hover:border-[#008080]  ${
                      path === "appinfo"
                        ? "bg-[#FF7F50] border-[1px] border-[#FF8356]"
                        : "bg-[#0A2239]"
